  ...
  return <main id="main">
    ...
    <section aria-labelledby="counselling-heading" className="page-shell pb-16 sm:pb-20">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_20px_60px_-40px_#33415540] sm:p-9">
        ...
        <div className="mt-5 flex gap-3 rounded-2xl border border-amber-100 bg-amber-50 p-5"><ChartNoAxesCombined size={19} className="mt-0.5 shrink-0 text-amber-700" /><p className="text-xs leading-6 text-amber-900">Predictions use the supplied 2025 AYUSH UG Round 1 allotment data. Final allotments depend on each year&apos;s official seat matrix, counselling rounds, eligibility rules, choice filling and category movement — use the results as a starting point, not a guarantee.</p></div>
      </div>
    </section>
