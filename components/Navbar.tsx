  ...
  return <>
    <header className="top-0 z-40 border-b border-slate-200/70 bg-white/90 sticky backdrop-blur-xl">
      <div className="gap-4 page-shell h-19 justify-between flex items-center">
        <Link href="/" aria-label="Exam Intel home" className="gap-2.5 flex items-center"><span className="justify-center rounded-xl bg-indigo-600 text-white flex size-9 shrink-0 items-center"><Compass size={24} strokeWidth={1.8} /></span><span className="leading-tight"><span className="text-[15px] font-bold text-slate-800 block tracking-tight sm:text-lg">Exam <span className="text-indigo-600">Intel</span></span><span className="text-[9px] font-medium text-slate-500 block tracking-wide sm:text-[10px]">College Predictor</span></span></Link>
